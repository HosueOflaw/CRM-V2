        ...
        const allSections: MenuItem[] = [
            ...
            },
            {
                ...
                items: [
                    ...
                    { label: 'رفع تصنيفات (Classifications)', icon: 'pi pi-fw pi-tags', routerLink: ['/secretariat/import-fileclassifications'] },
                    { label: 'رفع الملاحظات (Notes)', icon: 'pi pi-fw pi-comments', routerLink: ['/secretariat/import-notes'] },
                    { label: 'رفع مبالغ إضافية (Amounts)', icon: 'pi pi-fw pi-dollar', routerLink: ['/secretariat/import-additionalamounts'] },
                    { label: 'رفع المرفقات (Attachments)', icon: 'pi pi-fw pi-paperclip', routerLink: ['/secretariat/import-attachments'] },
                    { label: 'رفع البريد المجدول (Mails)', icon: 'pi pi-fw pi-envelope', routerLink: ['/secretariat/import-mails'] },
