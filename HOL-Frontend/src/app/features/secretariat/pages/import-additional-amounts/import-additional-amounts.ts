...
@Component({
    selector: 'app-import-additional-amounts',
    standalone: true,
    imports: [
        CommonModule,
        FormsModule,
    ...
    templateUrl: './import-additional-amounts.html'
})
export class ImportAdditionalAmountsPage implements OnInit, OnDestroy {
            ...
            if (state.jobType === 'AdditionalAmount') {
                if (state.status === 'Uploading') {
                    ...
                    if (this.selectedFile) {
                        this.swal.toast({ icon: 'info', title: 'بدأت المعالجة', text: 'يتم الآن رفع ومعالجة ملف المبالغ الإضافية في الخلفية' });
