...
export class ImportNotesPage implements OnInit, OnDestroy {
            ...
            if (state.jobType === 'Note') {
                if (state.status === 'Uploading') {
                    ...
                    if (this.selectedFile) {
                        this.swal.toast({ icon: 'info', title: 'بدأت المعالجة', text: 'يتم الآن رفع ومعالجة ملف الملاحظات في الخلفية' });
