...
@Component({
    selector: 'app-import-fileclassifications',
    standalone: true,
    imports: [
        CommonModule,
        FormsModule,
    ...
    templateUrl: './import-fileclassifications.html'
})
export class ImportFileClassificationsPage implements OnInit, OnDestroy {
            ...
            if (state.jobType === 'FileClassification') {
                if (state.status === 'Uploading') {
                    ...
                    if (this.selectedFile) {
                        this.swal.toast({ icon: 'info', title: 'بدأت المعالجة', text: 'يتم الآن رفع ومعالجة ملف تصنيفات الملفات في الخلفية' });
