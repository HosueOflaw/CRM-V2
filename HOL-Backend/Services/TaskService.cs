...
public class TaskService : ITaskService
{
    ...
    public async Task<EmployeeTaskDto> CreateTaskAsync(int supervisorId, CreateTaskDto dto)
    {
    ...
    {
        // Simple mapping, ensuring minimal null issues
        // In a real scenario, might want to eager load names if not included
